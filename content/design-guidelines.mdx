...
Primer Presentations uses the same [color system](https://primer.style/css/support/color-system) created for our product. MacOS has its own system-wide color picker for managing color palettes, meaning you can import our entire color system to customize your slides.
...
<img
  width="958"
  alt="Screenshot 2019-03-29 17 32 58"
