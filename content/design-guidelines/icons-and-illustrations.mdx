...
Below are guidelines on how to best use GitHub icons and illustrations within a presentation. Approved visual assets are provided within the [asset library](https://primer.style/presentations/assets).
